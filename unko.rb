...
people2 = People.new("ウンチポロンポローン", 200, 300, 5500)
...
#  end
  ...
  if people2.oppai < 4999
    ...
    sleep(2)
    puts "#{people2.name}の必殺技、、、自滅の遅咲きうんこ！！！"
    sleep(3)
    puts "*****************************"
    puts "決着！！！"
    puts "*****************************"
    sleep(1)
    puts "#{people2.name}瀕死、、#{people1.name}の勝利！！"
    break
  end
...
sleep(3)
  ...
  puts "#なぜか#{people3.name}は毎戦#{people2.name}のおっぱいポイントを攻撃します。"
